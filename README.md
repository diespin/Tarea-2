...
#### (d) 1.18 V
#### 7. Una resistencia de 2.2 MV se conecta a través de una fuente de 1 kV. La corriente resultante es de aproximadamente:
#### (b) 0.455 mA 
...
#### (a) el voltaje se triplica = se triplica
#### (b) el voltaje se reduce en 75% = se reduce un 75%
#### (c) la resistencia se duplica = se reduce a la mitad 
#### (d) la resistencia se reduce en 35% = incrementa un 35%
#### (e) el voltaje se duplica y la resistencia se reduce a la mitad = se incrementa cuatro veces  
#### (f) el voltaje y la resistencia se duplican = no pasa nada 
...
[![deber-2-c-2-2.png](https://i.postimg.cc/DyJtcWjN/deber-2-c-2-2.png)](https://postimg.cc/ykKQ1Nzh)
#### R1= 0.5Ω
#### R2= 1Ω
#### R3= 2Ω
...
#### R= 1.58kΩ, la relacion es de uno a unoa ya que si la una dismunuye la otra tambien, de igual manera si crece el voltaje lo hace tambien la intensidad.
...
#### (a) V=5V, R=1.OΩ => I=5A
#### (b) V=15V, R=10Ω => I=1.5A
#### (c) V=50V, R=100Ω => I=0.5A
#### (d) V=30V, R=15kΩ => I=2mA
#### (e) V=250V, R=5.6MΩ => I=44,64µA
